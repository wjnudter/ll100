	                   ...
	                   if(zhuangtai.equals("")){//第一次进入
					    ...
					    JSONArray p2=new JSONArray(a);
			               ...
			               for(int i=0;i<p2.length();i++){
							...
							message.sethomeworkJson(p4.getString("homeworks"));//作业内容
							message.sethomeworkpaperJson(p3.getString("homework_papers"));	//答题内容
							message.setclassJason(p4.getString("clazz"));
							message.setid(p4.getString("row_id"));							
							message.setremark(p4.getString("remark"));
